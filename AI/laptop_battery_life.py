# link to problem: https://www.hackerrank.com/challenges/battery/problem?isFullScreen=true
...
if __name__ == '__main__':
    ...
    # Read single float input from stdin
    time_charged = float(input().strip())

    # Predict: 2x if under 4h, else max 8h
    predicted_life = min(time_charged * 2, 8)
